    ...
    return (
        <Fragment>
            <section>
                ...
                <p>
                    I aim to be a polyglot T-shaped developer with deep expertise in one of the areas with time. <strong>I wanna be the very best of myself</strong> (read Ash Ketchum). 
